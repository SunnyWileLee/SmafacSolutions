...
namespace Smafac.Wms.Stock.Services.Category
{
    ...
    {
        public StockCategoryUpdateService(IStockCategorySearchRepository goodsCategorySearchRepository,
                                          IStockCategoryUpdateRepository goodsCategoryUpdateRepository)
        {
